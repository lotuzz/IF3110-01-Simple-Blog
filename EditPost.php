...
<?php
	if(!empty($_POST)) {
		...
		$query1='SELECT * FROM posts WHERE id="'.$_GET['id'].'" LIMIT 1';
...
<article class="art simple post">
    ...
    <div class="art-body">
        <div class="art-body-inner">
            ...
            <div id="contact-area">
TEST;
				echo '<form method="post" action="ViewPost.php?id='.$_GET['id'].'>';
                    ...
                    echo '<input type="text" name="Tanggal" id="Tanggal" value="'.$row['tanggal`'].'">';
                    
                    echo '<label for="Konten">Konten:</label><br>';
                    echo '<textarea name="Konten" rows="20" cols="20" id="Konten" value="'.$row['konten'].'"></textarea>';
